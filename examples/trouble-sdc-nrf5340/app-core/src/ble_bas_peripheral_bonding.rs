...
use crate::ble_bas_peripheral_bonding::settings_region::get_settings_region;
...
mod settings_region {
    ...
    pub fn get_settings_region() -> core::ops::Range<u32> {
        (&raw const __settings_start) as u32..(&raw const __settings_end) as u32
    }
}
...
async fn store_bonding_info<S: NorFlash>(
    ...
    sequential_storage::erase_all(storage, get_settings_region()).await?;
    let mut buffer = [0; 32];
